...
class DataTriage(object):
    ...
    top_100 : np.array(), shape(100_top_entries, )
        Array containing indices of the 100 data points with highest target values.
    ...
    def __init__(self, X, y):
        ...
        self.top_100 = np.argsort(self.y_true)[-100:]
